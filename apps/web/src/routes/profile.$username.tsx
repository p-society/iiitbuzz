            ...
            <main className="flex-1 container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="neo-brutal-card p-8 mb-8">
                        ...
                        {profile.bio && (
                            <div className="mb-6">
                                <p className="text-lg public-sans-font text-foreground">{profile.bio}</p>
                            </div>
                        )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {profile.branch && (
                                <div className="flex items-center gap-2">
                                    <span className="text-muted-foreground">📍</span>
                                    <span className="text-sm text-foreground">{profile.branch}</span>
                                </div>
                            )}
                            ...
                            {profile.passingOutYear && (
                                <div className="flex items-center gap-2">
                                    <span className="text-muted-foreground">📅</span>
                                    <span className="text-sm text-foreground">Class of {profile.passingOutYear}</span>
                                </div>
                            )}
                            
                            <div className="flex items-center gap-2">
                                <span className="text-muted-foreground">💬</span>
                                <span className="text-sm text-foreground">{profile.totalPosts} posts</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="neo-brutal-card p-8">
                        <h2 className="text-2xl font-bold pixel-font text-foreground mb-6">Recent Activity</h2>
